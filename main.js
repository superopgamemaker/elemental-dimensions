...
function gameLoop() {
	...
	game.hydrogenNuclei = Math.round(game.hydrogenNuclei * 50) / 50
	game.firstHydrogenDimension = Math.round(game.firstHydrogenDimension * 50) / 50
	document.getElementById("hydrogenDisplay").innerHTML = "You have " + game.hydrogenNuclei + " hydrogen nuclei."
